import { type Array, BoolArray } from "@zarrita/core";
import type {
	Async,
	Chunk,
	DataType,
...
type SupportedDataType = Exclude<DataType, D.UnicodeStr | D.ByteStr>;
...
function compat<D extends SupportedDataType>(
	arr: Chunk<D>,
): Chunk<Exclude<DataType, D.UnicodeStr | D.ByteStr | D.Bool>> {
...
const cast_scalar = <D extends Exclude<DataType, D.UnicodeStr | D.ByteStr>>(
	arr: Chunk<D>,
	value: Scalar<D>,
): Scalar<Exclude<DataType, D.UnicodeStr | D.ByteStr | D.Bool>> => {
...
function set_scalar<D extends Exclude<DataType, D.ByteStr | D.UnicodeStr | D.Bool>>(
...
function set_from_chunk<D extends Exclude<DataType, D.ByteStr | D.UnicodeStr | D.Bool>>(
