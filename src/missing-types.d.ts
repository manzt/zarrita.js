declare namespace ndarray {
  ...
  type Data<T = any> = T extends number ? GenericArray<T> | T[] | TypedArray
    : T extends bigint ? GenericArray<T> | T[] | BigInt64Array | BigUint64Array
    : GenericArray<T> | T[];
  ...
  type Value<D extends Data> = D extends GenericArray<infer T> | Record<number, infer T> ? T
    : never;
  ...
  type DataType<D extends Data = Data> = D extends Int8Array ? 'int8'
    ...
    : D extends BigInt64Array ? 'bigint64'
    : D extends BigUint64Array ? 'biguint64'
    : D extends GenericArray<unknown> ? 'generic'
    : 'array';
}

declare module 'ndarray' {
  export default function ndarray<D extends ndarray.Data = ndarray.Data<number>>(
    data: D,
    shape?: number[],
    stride?: number[],
    offset?: number,
